<template>
    <div class="signup-content">
        ...
        <div class="signup-form">
            ...
            <div
                id="registrationSuccessContainer"
            ...
            <div
                id="approvalMessageContainer"
                class="alert alert-info d-none text-center"
            >
            ...
            <form id="registrationForm" novalidate>
                ...
                <section class="form-box">
                    ...
                    <div class="form-field mt-5">
                        <label for="waiver_document"
                            >Supporting Document
                            <span class="text-danger"
                                >* (Upload relevant documentation (e.g.,
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-field">
                            ...
                            <input
                                ...
                                id="fathers_name"
                                required
                                aria-describedby="fathersNameError"
                                placeholder="Mr. Hariom Pradhan"
                            />
                            <div
                                id="fatherNameError"
                                class="invalid-feedback"
                        ...
                        <div class="form-field">
                            ...
                            <input
                                ...
                                name="mothers_name"
                                id="mothers_name"
                                aria-describedby="mothersNameError"
                                required
                                placeholder="Kirti Pradhan"
                            />
                            <div
                                id="motherNameError"
                                class="invalid-feedback"
                        ...
                        <div class="form-field">
                            ...
                            <input
                                ...
                                name="parent_contact"
                                id="parent_contact"
                                aria-describedby="parent_contactError"
                                required
                                placeholder="99999-99999"
                            />
                            <div
                                id="parent_contactError"
                                class="invalid-feedback"
                            ></div>
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input
                                ...
                                aria-describedby="localGuardianNameError"
                                required
                                placeholder="Rajat Pradhan"
                            />
                            <div
                                id="localGuardianNameError"
                                class="invalid-feedback"
                            ></div>
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input
                                ...
                                id="guardian_contact"
                                aria-describedby="guardian_contactError"
                                required
                                placeholder="99999-99999"
                            />
                            <div
                                id="guardian_contactError"
                                class="invalid-feedback"
                            ></div>
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input
                                ...
                                aria-describedby="emergency_contactError"
                                required
                                placeholder="99999-99999"
                            />
                            <div
                                id="emergency_contactError"
                                class="invalid-feedback"
                            ></div>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-field">
                            ...
                            <select
                                ...
                                id="Food"
                                required
                                aria-describedby="foodPreferenceError"
                            >
                                <option selected value="">
                                    Select Food Preference
                                </option>
                        ...
                        <div class="form-field">
                            ...
                            <select
                                ...
                                id="Bed"
                                required
                                aria-describedby="bedPreferenceError"
                            >
                                <option selected value="">
                                    Select Bed Preference
                                </option>
                ...
                <section class="form-box">
                    ...
                    <div class="form-field">
                        <label for="fathers_name"
                            >Additional Accessories (Optional)</label
                        >
                        <p name="" id=""></p>
                    </div>
                ...
                <section class="submit-btn-registration">
                    ...
                    <div
                        id="loading"
                        class="mt-3 text-center text-muted d-none"
                    >
                        Submitting...
                    </div>
                </section>
...
const apiBase = "/api"; // adjust if prefix needed
...
onMounted(() => {
    ...
    // Dynamic Faculty → Department → Course
    ...
    if (facultySelect) {
        facultySelect.addEventListener("change", async () => {
            ...
            try {
                const { data } = await axios.get(`${apiBase}/faculties/${facultySelect.value}/departments`);
    ...
    if (deptSelect) {
        deptSelect.addEventListener("change", async () => {
            ...
            try {
                const { data } = await axios.get(`${apiBase}/departments/${deptSelect.value}/courses`);
                courseSelect.innerHTML = `<option value="">Select Course</option>`;
                data.forEach(c =>
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${apiBase}/guest/register`, formData);
