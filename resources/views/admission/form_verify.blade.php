        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="fee_waiver" id="fee_waiver" value="1">
                        <label class="form-check-label" for="fee_waiver">Apply Fee Waiver</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="bihar_credit_card" id="bihar_credit_card" value="1">
                        <label class="form-check-label" for="bihar_credit_card">Bihar Credit Card</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="tnsd" id="tnsd" value="1">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="guardian_no" id="guardian_no" class="form-control" pattern="[0-9]{10}">
            ...
            <div class="mb-3">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="room_preference" value="Single" id="room_single" required>
                        <label class="form-check-label" for="room_single">Single</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="room_preference" value="Double" id="room_double">
                        <label class="form-check-label" for="room_double">Double</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="room_preference" value="Triple" id="room_triple">
...
<script type="text/javascript">
    ...
    $('#registrationForm input, #registrationForm select, #registrationForm textarea').on('input blur change', function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            let defaultHTML = '', additionalHTML = '';
    ...
    success: function(response) {
        ...
        if (response.success) {
            ...
            accessoryIds.forEach(function(id) {
                console.log(id);
                $(`input[name="accessories[]"][value="${id}"]`).prop("checked", true);
            });
            $('#name').val(guest.name);
            ...
            guest.bihar_credit_card==1?$('#bihar_credit_card').prop('checked', true):'N/A';
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success && Array.isArray(response.data)) {
                        ...
                        showAlert("danger", response.message || "No courses found for this department.");
                    }
                },
                error: function(xhr) {
                    showAlert("danger", "An error occurred while fetching courses.");
                }
            });
            ...
            if (Array.isArray(guest.accessories)) {
                guest.accessories.forEach(function(item) {
                    $(`input[name="accessories[]"][value="${item.id}"]`).prop("checked", true);
                });
            }
            
            if(guest.attachment_path)
            {
                $('#waiver_document_attachments').html(`<a style='text-decoration:none;' target='_new' href='${guest.attachment_path}'>Waiver Document</a>`);
            }
