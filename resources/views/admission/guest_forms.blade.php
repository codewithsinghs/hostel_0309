        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (!Array.isArray(guests) || guests.length === 0) {
                    guestsList.append(`<tr><td colspan="10" class="text-center">No guests found.</td></tr>`);
                    return;
                }
            ...
            error: function(xhr) {
                ...
                $("#guestsList").html(`<tr><td colspan="10" class="text-danger text-center">Error loading guests.</td></tr>`);
