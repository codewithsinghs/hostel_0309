...
Route::get('/resident/room-change-requests', function () {
    ...
    Route::view('/resident/payment/{student_accessory_id}', 'resident.make_payment')->name('resident.make_payment');
...
// Route::get('/login', function () {return view('fronteadnd.vuead.audfadth.login');})->name('login');

// Route::get('/admin', function () {return view('frontend.vue.admin.dashboard');})->name('admin.dashboard');
// Route::get('/admin/dashboard', function () {return view('frontend.vue.admin.dashboard');})->name('admin.dashboard');

// Route::get('/admin/users', function () {return view('frontend.vue.admin.users.index');})->name('admin.users.index');
// Route::get('/admin/users/create', function () {return view('frontend.vue.admin.users.create');})->name('admin.users.create');

// Route::get('/admin/users/{users}/edit', function () {return view('frontend.vue.admin.users.edit');})->name('admin.users.edit');
// Route::get('/admin/users/{users}/view', function () {return view('frontend.vue.admin.users.show');})->name('admin.users.show');
...
// API routes in routes/api.php for data
